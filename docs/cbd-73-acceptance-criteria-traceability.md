...
| `docs/cbd-91-private-mvp-data-inventory.md` | Document version **1.0.2**, approved | `fa3fb737d937896b0901ee965b46d6a4d7e1412b` | Existing data-class, audience, lifecycle, and prohibited-disclosure boundaries; source alignment and new/split classes remain `OI-73-003` |
| `docs/cbd-94-risk-mitigation-requirement-register.md` | Document version **1.0.1**, approved provider-independent baseline | `9c751c58a771d2494e94f69e1c77b2ab5a5e8040` | Normative `SR-94-007`–`SR-94-011` invitation security/privacy requirements and dependent release gates |
