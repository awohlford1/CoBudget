...
| `docs/cbd-95-architecture-roadmap-follow-up-register.md` | Front-matter status says **Approved v1.0.1** while the observed Document version is **1.0.9** | `92948bc3cd976c6155c1c23c3b7c872826706d43` | Product Owner dispositions for `RI-93-001`–`RI-93-019`, follow-up ownership, safety-channel routing, and copy/implementation gates |
