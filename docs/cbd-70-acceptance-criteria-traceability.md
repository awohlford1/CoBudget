...
All of these conditions were met at version 1.0. Bidirectional coverage is complete and mechanically verified (§8.3), every calculation reproduces (§8.3), no in-MVP decision remains open (§6), and all four review passes are complete with every finding resolved (§§8.1–8.2).
...
Every governing criterion below is mapped to approved scenario evidence in both directions. The two criteria labelled `Approved — collective` are the collective-coverage criteria described under §3.2; their satisfaction is by the catalog as a whole rather than by a named scenario.
...
| --- | --- | --- | --- | --- |
| CBD-67-AC01 | Weekly setup documents the Monday default and selection of any weekday anchor. | §§5–6, 19 | PER-W-01, PER-W-02 | Approved |
| CBD-67-AC02 | Initial weekly and monthly onboarding opens the complete current anchored period. | §§5–7 | PER-W-01, PER-M-01, SET-01 | Approved |
| CBD-67-AC03 | Monthly setup supports numbered anchors 1 through 31 and an explicit Last day option. | §6 | PER-M-01–03, SET-02 | Approved |
| CBD-67-AC04 | Missing monthly dates, February, and leap-year cases clamp to the final valid date and return to the selected numbered anchor when possible. | §6 | PER-M-02, PER-M-03, SET-02 | Approved |
| CBD-67-AC05 | Weekly and monthly dates, local-midnight behavior, and previews use the authoritative budget time zone. | §§3, 5–6, 14 | PER-W-01, PER-W-02, TXN-04 | Approved |
| CBD-67-AC06 | Required inputs, validation messages, confirmation behavior, and setup previews showing the current period plus at least the next three periods are documented. | §§5–7, 14, 17 | SET-01, SET-02, VAL-01 | Approved |
| CBD-67-AC07 | Schedule changes require an exact effective date of today or a future date and reject past dates. | §8 | CHG-01–04, CHG-09 | Approved |
| CBD-67-AC08 | Today uses the budget calendar date at local midnight, and the MVP permits only one pending future change per budget. | §§3, 8, 13–14 | CHG-02, CHG-08 | Approved |
| CBD-67-AC09 | A pending change remains visible, editable, and cancelable until execution while the current schedule remains authoritative. | §§4, 8, 13–14 | CHG-02, CHG-06–08, SEC-01 | Approved |
| CBD-67-AC10 | A mid-period change closes the old period through the previous day and creates the defined transition period. | §§8–10 | CHG-01, CHG-02, E2E-01 | Approved |
| CBD-67-AC11 | A boundary-aligned change starts a full period without unnecessary proration. | §§8–10 | CHG-03, CHG-04 | Approved |
| CBD-67-AC12 | Planned category allocations are prorated by included calendar days, while actual transactions and bills are never prorated. | §§9–12, 16 | CHG-01, FIN-01, TYPE-02, E2E-01 | Approved |
| CBD-67-AC13 | Positive remaining amounts stay in the completed or closed period’s history and are not carried into a transition or later period during the MVP. | §§10–11, 13, 19 | HIST-01, FIN-02 | Approved |
| CBD-67-AC14 | Overspending stays in completed or closed period history, no balance is carried forward, and rollover is explicitly deferred. | §§10–11, 13, 19 | HIST-01, FIN-03, ALERT-02, E2E-01 | Approved |
| CBD-67-AC15 | Change previews show the old period, transition period when applicable, first full new period, allocation changes, affected bills, and affected transactions. | §§8–12, 16 | CHG-01–04, FIN-01, TYPE-02, E2E-01 | Approved |
| CBD-67-AC16 | Confirmation explicitly identifies the effective date, new cadence and anchor, and proration result. | §§8–10, 12, 14 | CHG-01–04, FIN-01, E2E-01 | Approved |
| CBD-67-AC17 | Scheduled, edited, canceled, confirmed, and executed changes create auditable records. | §§8, 13–15, 18 | CHG-02, CHG-04, CHG-06, CHG-07, CHG-10, HIST-01, SEC-02, E2E-01 | Approved |
| CBD-67-AC18 | Completed periods retain their dates, planned amounts, actual amounts, and schedule-version references. | §§13, 15, 18 | CHG-10, HIST-01, LATE-01, E2E-01 | Approved |
| CBD-67-AC19 | Examples cover weekly-to-monthly and monthly-to-weekly changes across immediate, future, mid-period, and boundary-aligned cases; deferred rollover and unresolved questions are recorded as follow-up work. | §§19–20 and approved scenario catalog | CHG-01–04, FIN-02, FIN-03 | Approved |

### 3.2 CBD-68 — Paycheck, income, and custom schedules

| Requirement ID | Authoritative requirement summary | Specification evidence | CBD-70 scenarios | Inventory status |
| --- | --- | --- | --- | --- |
| CBD-68-AC01 | Paycheck-period start and end rules are independent of occurrence exceptions. | §§7, 11, 15–17 | PER-PAY-01–03, E2E-02 | Approved |
| CBD-68-AC02 | All income schedules use one canonical budget timeline. | §§5, 7–8 | PER-PAY-01, PER-SEMI-01, PER-MULTI-01, INC-01, E2E-02 | Approved |
| CBD-68-AC03 | Anchor and secondary income schedules have explicit behavior. | §§8–9 | PER-MULTI-01, INC-01 | Approved |
| CBD-68-AC04 | Spending target, expected income, actual income, current cash, pending activity, settled activity, and actual spending remain distinct. | §§2, 4, 6 | FIN-01, INC-01, INC-02, INC-07, E2E-01, E2E-02 | Approved |
| CBD-68-AC05 | Expected income affects neither actual cash nor spending targets. | §§2, 6, 12–13 | INC-02, E2E-01, E2E-02 | Approved |
| CBD-68-AC06 | Actual income updates actual reporting without modifying spending targets or requiring allocation. | §§2, 6, 13 | INC-03, INC-04, INC-06, INC-07, E2E-01, E2E-02 | Approved |
| CBD-68-AC07 | The previous-business-day default and supported alternatives have explicit behavior. | §10 | PER-SEMI-02, INC-08, INC-09, E2E-02 | Approved |
| CBD-68-AC08 | US holiday handling, occurrence overrides, and previews have explicit behavior. | §§10–11, 15 | PER-SEMI-02, PREV-01, INC-08–10, HOL-01, E2E-02 | Approved |
| CBD-68-AC09 | Shift, skip, extra, and amount occurrence exceptions modify projections only. | §11 | PER-PAY-02, INC-04–06, INC-10, VAL-04, E2E-02 | Approved |
| CBD-68-AC10 | Early, late, missing, unexpected, and different-amount income outcomes have explicit behavior. | §§12–13, 19 | INC-03, INC-04, INC-05, INC-06, INC-07, E2E-02 | Approved |
| CBD-68-AC11 | Semimonthly schedules, multiple anchors, duplicate adjusted dates, and short months have explicit behavior. | §§9–10 | PER-SEMI-01, PER-SEMI-02, VAL-04 | Approved |
| CBD-68-AC12 | Custom recurrence is bounded, fixed-length, contiguous indefinitely, editable, and validated at 1–366 days. | §14 | PER-CUST-01, PER-CUST-02, VAL-02, VAL-03 | Approved |
| CBD-68-AC13 | Active schedule changes follow CBD-67 through the cadence-neutral boundary-and-target adapter. | §§8, 11, 14–17, 20 | SET-03, CHG-05, CHG-10, E2E-02 | Approved |
| CBD-68-AC14 | Normal and exceptional examples cover all behavioral sections. | All behavioral sections | PER-PAY-01–03, PER-SEMI-01, PER-SEMI-02, PER-CUST-01, PER-CUST-02, INC-01–10, HOL-01, CHG-05, E2E-02 | Approved — collective |
| CBD-68-AC15 | MVP limitations and deferred automation are explicit. | §§2–3, 22, 24–25 | FIN-02, FIN-03 | Approved |
| CBD-68-AC16 | The product definition is sufficient for data, interface, reconciliation, accessible interaction, and deterministic tests while preserving future hybrid compatibility. | §§15–23 | SET-03, PREV-01, PREV-02, A11Y-01, CHG-05, HOL-01, REC-05, SEC-03, RECOV-01, E2E-01, E2E-02 | Approved — collective |
...
| Requirement ID | Authoritative requirement summary | Specification evidence | CBD-70 scenarios | Inventory status |
| --- | --- | --- | --- | --- |
| CBD-69-AC01 | Authorization date, posted or settlement date, transaction time, derived budget date, and date-source provenance have distinct definitions. | §§3, 5.1 | TXN-01–04, REP-01, E2E-02 | Approved |
| CBD-69-AC02 | Expenses use the authorization date when available and the posted or settlement date as fallback. | §§5.1, 6 | TXN-01–03, E2E-02 | Approved |
| CBD-69-AC03 | Transaction time is not used for budget-period classification, and a date supplied without a reliable time is used as provided. | §§3, 5.1, 6 | TXN-04 | Approved |
| CBD-69-AC04 | Pending expenses create a visible provisional category impact rather than finalized spending. | §§5.2, 6, 7.1 | TXN-01, REC-01, ALERT-01, E2E-01, E2E-02 | Approved |
| CBD-69-AC05 | Settlement replaces the provisional amount while retaining the authorization-based budget date. | §§6, 7.2 | TXN-01, TXN-02, REC-04, REC-05, AUDIT-01, E2E-01, E2E-02 | Approved |
| CBD-69-AC06 | Missing, changed, removed, unmatched, and duplicate pending or posted transactions have explicit reconciliation behavior. | §§6, 7.1–7.3 | TXN-03, REC-01, REC-02, REC-03, REC-04, REC-05, RECOV-01, ALERT-01, AUDIT-01 | Approved |
| CBD-69-AC07 | Income is counted only when posted, settled, or manually confirmed and never changes budget values automatically. | §§1–3, 5.1, 6, 8 | INC-02–07, E2E-02 | Approved |
| CBD-69-AC08 | Transfers, refunds, bills, and manually entered transactions have explicit classification and date rules. | §§6, 9.1–9.4 | TYPE-01–04 | Approved |
| CBD-69-AC09 | Late-settling activity may adjust an ended period without changing its schedule boundaries or version. | §§6, 10 | HIST-01, TXN-02, LATE-01, ALERT-03, AUDIT-01, E2E-02 | Approved |
| CBD-69-AC10 | Late-adjusted periods and authorization-versus-statement date differences have clear user-facing explanations. | §§10–11 | LATE-01, TYPE-03, ALERT-03, REP-01, E2E-02 | Approved |
| CBD-69-AC11 | Pending activity uses informational warnings, while firm settled overspending and late-adjustment alert behavior is documented for owners, collaborators, and Accountability Partners. | §§3–4, 12 | LATE-01, ALERT-01–04, AUDIT-01, E2E-01, E2E-02 | Approved |
| CBD-69-AC12 | Original dates, date-source provenance, budget-date overrides, permissions, and reconciliation decisions remain auditable. | §§4, 6, 13 | REC-05, OVR-01, TYPE-04, SEC-01–03, ALERT-04, AUDIT-01, E2E-01, E2E-02 | Approved |
| CBD-69-AC13 | The decision matrix covers time zones, daylight-saving behavior, inclusive display boundaries, internal start-inclusive and end-exclusive boundaries, leap years, short months, gaps, overlaps, invalid ranges, duplicate anchors, skipped paydays, and schedule changes. | §§3, 6 | PER-W-02, PER-M-02, PER-M-03, PER-SEMI-02, PER-CUST-02, TXN-04, VAL-02–04 | Approved |
| CBD-69-AC14 | Every edge case identifies the expected period and financial-state impact plus a validation message, customer explanation, or recovery path. | §6 | CHG-09, REC-02, OVR-01, VAL-01–04, SEC-02, SEC-03, RECOV-01, E2E-02 | Approved |
| CBD-69-AC15 | The output is detailed enough to design database fields, interface states, reconciliation logic, reports, alerts, audit events, and automated tests. | §§11–16 | REC-05, SEC-03, RECOV-01, ALERT-04, REP-01, AUDIT-01, E2E-01, E2E-02 | Approved |
...
| --- | --- | --- | --- |
| CBD-70-AC01 | A standard scenario template is documented and used consistently. | Scenario catalog §5; used by all 75 drafted scenarios | Approved evidence |
| CBD-70-AC02 | A fixed reference dataset defines dates, time zone, currency, schedules, income, and category budgets. | [Calendar example set](cbd-70-calendar-example-set.md) §§2–4; scenario catalog §3 | Approved evidence |
| CBD-70-AC03 | A traceability matrix maps every confirmed CBD-67 through CBD-69 criterion to scenario coverage. | This record §3; scenario catalog §4 | Approved evidence |
| CBD-70-AC04 | Every supported cadence has a normal period-generation example. | PER-W-01, PER-M-01, PER-PAY-01, PER-PAY-03, PER-SEMI-01, PER-MULTI-01, PER-CUST-01; PER-PAY-03 explicitly closes the six-pattern paycheck matrix | Approved evidence |
| CBD-70-AC05 | Weekly, monthly, paycheck, semimonthly, multiple-anchor, and custom boundary cases are covered. | PER-W-02, PER-M-02, PER-M-03, PER-PAY-02, PER-SEMI-02, PER-MULTI-01, PER-CUST-02 | Approved evidence |
| CBD-70-AC06 | Immediate, future, mid-period, and boundary-aligned schedule changes have exact expected results. | CHG-01–05 | Approved evidence |
| CBD-70-AC07 | Proration, MVP no-carry-forward disposition, transition-period targets, and overspending behavior have exact monetary results. | FIN-01–03, CHG-01 | Approved evidence |
| CBD-70-AC08 | Multiple-income examples demonstrate one canonical budget timeline with anchor and secondary income schedules. | PER-MULTI-01, INC-01, PREV-01, E2E-01 | Approved evidence |
| CBD-70-AC09 | Spending targets, expected income, actual income, current cash position, pending activity, settled activity, and actual spending remain distinct in every applicable example, and income receipt does not fund categories. | INC-01–07, INC-10, AUDIT-01, E2E-01, E2E-02 | Approved evidence |
| CBD-70-AC10 | Authorization-date classification, pending settlement, posted-date fallback, reconciliation, and late adjustments are covered. | TXN-01–04, REC-01–05, LATE-01 | Approved evidence |
| CBD-70-AC11 | Invalid schedules, gaps, overlaps, duplicate anchors, invalid dates, duration limits, prohibited changes, direct unauthorized requests, and attempts to use occurrence exceptions as boundary edits produce defined responses. | CHG-08, CHG-09, VAL-01–04, SEC-03, ALERT-04 | Approved evidence |
| CBD-70-AC12 | Short months, leap years, holidays, business-day adjustments, unavailable holiday years, holiday-source corrections, and daylight-saving cases have explicit results. | PER-W-02, PER-M-02, PER-M-03, PER-SEMI-02, INC-08, INC-09, HOL-01, TXN-04 | Approved evidence |
| CBD-70-AC13 | Each scenario defines expected period, budget, projection, transaction, validation, alert, and audit outcomes where applicable. | Scenario catalog §§5.2–5.7; all 75 scenarios drafted | Approved evidence |
| CBD-70-AC14 | All dates, state transitions, and calculations are deterministic and reproducible without undocumented assumptions. | Scenario catalog §§3, 5.2–5.7; all 75 scenarios drafted | Approved evidence |
| CBD-70-AC15 | Monetary examples follow one documented rounding policy, and proration inputs, formulas, intermediate values, and final results are visible. | Governance D13–D14; calendar example set §3; FIN-01 | Approved evidence |
| CBD-70-AC16 | Unresolved or contradictory requirements are explicitly identified and returned for product review rather than resolved through assumptions. | §6; governance D03 and D21; documented TYPE-04 correction | Approved evidence |
| CBD-70-AC17 | The catalog is reviewed and approved as sufficiently precise for later conversion into automated tests without changing expected outcomes. | §8; governance D23–D24; four review passes complete, all findings resolved, Product Owner approval granted August 14, 2026 | Approved evidence |
| CBD-70-AC18 | Completion requires the scenario catalog, calendar examples, and traceability matrix but does not require application code or automated-test implementation. | This record; [scenario catalog](cbd-70-scenario-catalog.md); [calendar example set](cbd-70-calendar-example-set.md); governance D24 | Approved evidence |
...
| Governing criteria mapped to approved CBD-70 scenarios | 50 of 50 | Complete |
...
| CBD-70 scenarios | 75 | Final count after review-driven expansion |
...
| --- | --- | --- |
| Scenario identity and count | Passed | Registry and detailed sections contain the same 75 unique IDs and titles; all 75 registry rows are Approved. |
