...
| Primary evidence | `docs/cbd-92-system-flow-technical-threat-model.md` v0.1.18 |
...
| Architecture/provider findings | Technical model §9.2 | Drafted as RF-92-001–011 |
...
| --- | --- | --- | --- |
| CBD-92-AC01 | Every inventory flow crosses only documented boundaries. | Technical model §§4–6; this record §4 | Structurally met: all 13 flows map to named boundaries and entry points, and technical model §6 is now the single authoritative statement of that relation, with §5 as its reverse index and §7 threats confined to boundaries their own flows reach. The reconciliation that produced this agreement is `RF-92-011` and is itself unapproved. Boundary enforcement is unverified. |
...
| DF-91-004 | Provider consent/link/callback/secret handling | §§4.1, 4.3 | TB-92-001–002, 004–006, 010–011, 017 | EP-92-005, 015 | Covered conceptually; provider evidence open |
...
| DF-91-010 | Export generation, storage and download | §§4.1, 4.4 | TB-92-001–002, 004–006, 008–009, 013–014, 017 | EP-92-007, 011–012, 015 | Covered conceptually; format/storage contract open |
...
| ID | Finding | Status |
| --- | --- | --- |
| RV-92-001 | All 13 approved CBD-91 flows have named trust-boundary crossings, and the technical model now states that relation once in §6 rather than three times inconsistently across §5, §6 and §7. | Structurally complete; the reconciliation is RF-92-011 and is unapproved |
...
| RV-92-004 | All 45 threats cite assets and governing inputs; missing implementation or provider evidence is cited as a gate rather than treated as authority. All 37 CBD-72 citations were read against the source: each resolves to a real permission, invariant, section or scenario, and the six that named a non-governing invariant were repointed. TH-92-034 records that CBD-72 sets no rate or resource ceiling outside export packages. | Structurally complete; citations verified against source |
| RV-92-005 | EG-91-001–024 are consumed and RF-92-001–011 define the missing architecture, provider, schema, legal or verification evidence and blocking effect. Only RF-92-011 needs a further CBD-92 decision, and that decision confirms a reconciliation rather than setting a new product rule. | Structurally and decision complete except RF-92-011 |
...
| RV-92-007 | Product Owner has not approved CBD-92 v0.1.18 as a complete document or any downstream mitigation/risk disposition. | Open approval gate |
...
| --- | --- | --- | --- | --- |
| 0.1.18 | August 16, 2026 | Claude with Alexander Wohlford as Product Owner | Synchronized §4 with the reconciled technical model §6 crossing map, qualified the CBD-92-AC01 assessment and RV-92-001 with the reconciliation that produced it, added RV-92-005P and RF-92-011 to the finding set, extended the non-privileged-actor note to name ACT-92-001 and ACT-92-002, supplied the missing spoofing-omission justifications for EP-92-004/008/012/013/015, and corrected the §9 closing sentence that re-listed evidence gaps already cited in the table above it. Recorded the CBD-72 citation verification in §8 and RV-92-004. | Consistency, ambiguity and citation review; complete document remains pending Product Owner approval |
