...
| Document version | 0.72 |
| Owner | Alexander Wohlford |
| Reviewer | Alexander Wohlford — Product Owner. **Not yet reviewed.** |
| Jira | [CBD-108](https://cobudget.atlassian.net/browse/CBD-108) |
| Parent | [CBD-15](https://cobudget.atlassian.net/browse/CBD-15) — Select initial managed providers |
| Companions | Provider Set Disposition Register v0.69; Cross-Category Coherence Review v0.69; Combined Cost Model v0.69; Acceptance Criteria Traceability v0.69; Evidence Retrieval Pass v0.69 |
...
| **D4** | Requires provider contact — no published document can answer it. **Partly falsified for `OQ-107-020` on September 4, 2026**: a published document answered its metering half — retrieval pass §4.78, `OI-108-080` | 10 | `OI-103-015`, `OI-107-018`, `OQ-103-011`, `OQ-104-005`, `OQ-104-006`, `OQ-104-021`, `OQ-107-008`, `OQ-107-010`, `OQ-107-020`, `OQ-130-014` |
