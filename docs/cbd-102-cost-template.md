...
| Companions | [Hard-Gate Catalog](cbd-102-provider-requirements-hard-gate-catalog.md) v0.1.0; [Evaluation Rubric](cbd-102-provider-evaluation-rubric.md) v0.1.0; [Demand Model](cbd-102-demand-model.md) v0.1.0 |
