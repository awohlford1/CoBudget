...
| Version | Date | Change |
| --- | --- | --- |
| 1.3 | September 3, 2026 | Brand amendment. The email boundary specification's invitation row restated `EM-92-002` as "a CoBudget invitation" and now says MoneyPact, matching the amended contract at CBD-92 v1.0.1. No gate outcome, verdict, observation, price, `ED-106-*` decision, or acceptance-criterion status changes. |
