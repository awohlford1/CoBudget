...
| RF-08 | August 12, 2026 | CBD-68 cross-document permission audit | The CBD-67 permission matrix authorized Collaborators to perform schedule changes, but several narrative, audit, interface-state, recovery, and verification passages incorrectly restricted those actions to Owners and Co-owners. | Made the matrix authoritative throughout: Primary Owner, Co-owner, and Collaborator are authorized schedule editors. Viewer remains read-only. Accountability Partner remains financially read-only while personal acknowledgements and attributed comments are separately permitted. Owner/Co-owner-only authority is retained for the separate budget-time-zone setting. Updated REC-04 and verified consistency with CBD-68 PD-68-12 and FF-001. | Resolved — approved by Product Owner; terminology clarified August 15, 2026 |
...
| 1.3 | August 12, 2026 | Alexander Wohlford with Codex assistance | Resolved RF-08 by making the authoritative permission matrix consistent throughout the CBD-67 package: Collaborators may perform cadence schedule changes without separate Owner approval; Viewer remains read-only; Accountability Partner remains financially read-only with personal acknowledgements and attributed comments separately permitted; time-zone changes remain Owner/Co-owner-only. Updated REC-04 and aligned with CBD-68 PD-68-12. Terminology clarified August 15, 2026. |
