...
| CBD-71-AC03 | Validation is explicitly Product Owner approval, internal consistency, implementation readiness, and architecture alignment without a market-validation claim. | Register §1; checklist §1 | Checklist §§1, 4 | Draft evidence complete; architecture-alignment pass outstanding |
...
| CBD-71-AC09 | Accepted decisions have an auditable chain to CBD-1, CBD-11, CBD-67 through CBD-70, and scenarios. | Source column in SD-071-020–049; governance §3.4 chain and GC-01–08 source columns; register §2 | Source/traceability review in checklist §4 | Draft evidence complete; independent verification pending |
...
| CBD-71-AC13 | Product, technical, security, privacy, accessibility, role, and operational implications are reviewed. | Register §§3.3–3.4 and implication column in SD-071-020–049 | Architecture-alignment review in checklist §4 | Recorded; review pending |
...
| AC18 | Deterministic examples and test-ready traceability | SD-071-020–049; governance §3.4 (GC-01–08); approved CBD-70 package | Covered in draft |
...
| Required review passes complete | Source and traceability complete; decision quality initial pass complete; calendar and calculation partially complete; architecture alignment not started |
