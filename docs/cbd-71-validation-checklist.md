...
| Field | Value |
| --- | --- |
| Status | **v1.1 amendment validation complete — Product Owner approval outstanding** |
...
| Product Owner approval is recorded for this exact revision. | Register §9 | **Pending** — the only outstanding v1.1 gate |
| Approved set is issued as MVP Schedule Decisions v1.1. | Register front matter and §9 | Pending on the approval above |
...
| SD-071-044 | Personal notification channels and consent; recipient-only preference control | Pass | Pass | Pass | **Pass** — source evidence approved as CBD-69 v1.1 | Pass | Pass | Pass | Pass | Pass | Pending | Proposed v1.1 amendment |
...
| Active decisions Accepted for MVP | 30 of 31 — `SD-071-044` is Proposed pending the v1.1 approval |
| Governing criteria represented | 50 of 50 |
| Proposed MVP decisions | 1 — `SD-071-044` |
| Approved scenarios referenced | 75 of 75 |
| Blocking gate | Product Owner approval of the v1.1 revision. The CBD-69 source approval, consistency review, change record, and impact assessment are complete; Confluence publication follows the merge to `main` |

MVP Schedule Decisions v1.0 remains the approved release until v1.1 is approved. Every v1.1 gate is now closed except the Product Owner approval itself; `SD-071-044` stays Proposed and its v1.0 text stays authoritative until that approval is recorded in register §9.
