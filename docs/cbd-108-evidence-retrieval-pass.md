...
| OQ-108-080 | **Does the `HG-102-004` provider-level decision extend to Google Cloud's two candidates?** The console argument does not distinguish the providers. | Takes the observation pass from 28 to 27. Not assumed, because the decision was put for AWS. |
