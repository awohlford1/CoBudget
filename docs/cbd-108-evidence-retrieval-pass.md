...
| OQ-108-074 | **What constitutes *"a full re-evaluation"* under `EX-102-006`?** The phrase appears in the corpus **once**, inside the rule itself; no section says what it consists of, who performs it, or what it produces. | **Now governs eight gates** — `HG-102-011`, `012`, `013`, `035`, `042`, `052`, `053` and `065` all cite the CBD-91 §5.1 provider row. **A rule that redirects to an undefined procedure does not redirect anywhere**, and it is the only route left for `EXC-108-002` and `EXC-108-003` |
