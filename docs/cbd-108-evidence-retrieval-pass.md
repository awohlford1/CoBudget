...
| OQ-108-060 | **What compensating control addresses the region limb of `HG-102-013`?** Cryptographic erasure bounds a copy's **lifetime**, not its **location**, and C1 and C3 fail on region. | **The drafted exceptions do not rescue C1 or C3.** Their honest options are composition change — dropping Cloud Scheduler and Front Door, already with CBD-103 at `OQ-108-028` — or provider contact. Neither is an exception |
