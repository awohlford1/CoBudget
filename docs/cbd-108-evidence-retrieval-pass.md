...
| OQ-108-079 | **Are Low and High subtotals worth computing, given the free-tier structure?** §4.80 found category H's usage lines free at Base *and* High, so its figure does not scale with demand. | The ticket asks for low/base/high. Mechanically scaling Base would be wrong for H and misleading for the set. Recorded so the deliverable's shape is a decision rather than an omission. |
