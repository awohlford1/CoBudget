...
| Core invariants available for verification | 22 | Expanded from 10 in v0.1, then from 20 by the Product Owner review (INV-69-21 refund netting, INV-69-22 Duplicate-review counting). |
...
| Scenario IDs in the catalog | 32 (all fully worked fixtures; no compact assertion-table entries) | Coverage depth is documented in Scenario Catalog §1, following the CBD-67 RF-07 convention. Three fixtures were added by the Product Owner review (DATE-02a, REC-02b, REV-01a). |
