...
| AC-02 | Expenses use the authorization date when available and the posted or settlement date as fallback. | §5.1, §6 (EC-69-01, EC-69-02) | DATE-01, DATE-02 | INV-69-05 | CBD-11-AC02; CBD-1-AC01 | Complete for Final Draft | Not started |
...
| AC-06 | Missing, changed, removed, unmatched, and duplicate pending or posted transactions have explicit reconciliation behavior. | §6 (EC-69-04–07), §7.1–7.3 | PEND-02–04, REC-01, REC-02, REC-02a, REC-03 | INV-69-06 | CBD-11-AC03, AC20; CBD-1-AC01 | Complete for Final Draft — resolves OD-69-01 | Not started |
...
| AC-08 | Transfers, refunds, bills, and manually entered transactions have explicit classification and date rules. | §6 (EC-69-11–15), §9.1–9.4 | TYPE-01–03, REV-01, REV-02 | INV-69-08 | CBD-11-AC01, AC02, AC09; CBD-1-AC01 | Complete for Final Draft — resolves RF-69-02 | Not started |
...
| AC-10 | Late-adjusted periods and authorization-versus-statement date differences have clear user-facing explanations. | §10, §11 | LATE-01, REP-01 | INV-69-04, INV-69-16, INV-69-17 | CBD-11-AC05, AC06; CBD-1-AC01 | Complete for Final Draft — resolves OD-69-02 | Not started |
| AC-11 | Pending activity uses informational warnings, while firm settled overspending and late-adjustment alert behavior is documented for owners, collaborators, and Accountability Partners. | §4, §12.1–12.2 | ALT-01, ALT-02 | INV-69-15, INV-69-16 | CBD-11-AC06; CBD-1-AC01 | Complete for Final Draft — resolves OD-69-03 for the CBD-69-scoped portion; channel, threshold, cooldown, and quiet-hours configuration remains CBD-12 scope | Not started |
...
| AC-14 | Every edge case identifies the expected period and financial-state impact plus a validation message, customer explanation, or recovery path. | §6 (all 24 rows carry all nine required columns) | All scenarios | INV-69-17 | CBD-11-AC14, AC15, AC16, AC20; CBD-1-AC01 | Complete for Final Draft | Not started |
...
| Core invariants available for verification | 20 | Expanded from 10 in v0.1. All remain candidates for executable verification. |
| Classification matrix rows | 24 | Each row carries all nine columns required by the Jira Description. Expanded from 20 rows with five columns in v0.1. |
| Required case families from the Jira Description | 17 of 17 covered | Each named case maps to at least one EC-69 row; see §5. |
| Scenario IDs in the catalog | 29 (all fully worked fixtures; no compact assertion-table entries) | Coverage depth is documented in Scenario Catalog §1, following the CBD-67 RF-07 convention. |
...
| --- | --- | --- | --- |
| 1 | Missing authorization date | EC-69-02 | DATE-02 |
...
| 7 | Apparent pending/posted duplicates | EC-69-07 | PEND-04, REC-01, REC-03 |
...
| 10 | Refunds and reversals | EC-69-13, EC-69-14 | REV-01, REV-02 |
...
| RF-69-06 | August 12, 2026 | Approval independence | No review of any kind has been recorded for CBD-69. CBD-67 required, under its amended §7.7 governance rule, an independent review pass by a reviewer other than the author of the drafts under review before a version may be marked Approved. | v0.9 is submitted as In Review, not Approved. An independent pass over these drafts is required before approval; the CBD-67 §7.7 concession permitting an AI-assisted independent audit for product-documentation scope applies here, provided the audit is performed on drafts the approver did not write and its findings are recorded. | Open — approval gate |
...
| Product Owner review | Not performed | Not performed | Required | Not started |
| Independent review pass by a reviewer other than the drafts' author | Not performed | Not performed | Required by the CBD-67 §7.7 governance rule before any version may be marked Approved (RF-69-06) | Not started |
