...
| AC-11 | Pending activity uses informational warnings, while firm settled overspending and late-adjustment alert behavior is documented for owners, collaborators, and Accountability Partners. | §3 (Firm alert, Informational alert), §4, §12 | ALT-01, ALT-02, ALT-03 | INV-69-15, INV-69-16, INV-69-23 | CBD-11-AC06; CBD-1-AC01 | Complete for Final Draft — resolves OD-69-03 for the CBD-69-scoped portion. The firm/informational distinction was undefined until v0.9.4 (RF-69-13); channel, threshold, cooldown, and quiet-hours configuration remains CBD-12 scope | Not started |
...
| Core invariants available for verification | 23 | Expanded from 10 in v0.1, then by the Product Owner review: INV-69-21 refund netting, INV-69-22 Duplicate-review counting, INV-69-23 the firm-versus-informational alert contract. |
...
| Scenario IDs in the catalog | 33 (all fully worked fixtures; no compact assertion-table entries) | Coverage depth is documented in Scenario Catalog §1, following the CBD-67 RF-07 convention. Four fixtures were added by the Product Owner review (DATE-02a, REC-02b, REV-01a, ALT-03). |
...
| RF-69-06 | August 12, 2026 | Approval independence | No review of any kind has been recorded for CBD-69. CBD-67 required, under its amended §7.7 governance rule, an independent review pass by a reviewer other than the author of the drafts under review before a version may be marked Approved. | Partially addressed. The August 12 Product Owner review (§9) was performed by a reviewer who did not author the drafts, which satisfies the literal §7.7 requirement, and it produced five substantive findings (RF-69-08 through RF-69-12). It does **not** reproduce CBD-67 v1.2's separation: there, the independent auditor had not written the drafts under audit, whereas here Claude both authored v0.9.2 and presented the review findings. Whether that is sufficient for this documentation-scope subtask is an explicit Product Owner judgment that has not yet been recorded. | Open — approval gate, narrowed |
...
- [x] Product Owner review of the full package performed, with findings recorded and resolved (RF-69-08 through RF-69-12).
