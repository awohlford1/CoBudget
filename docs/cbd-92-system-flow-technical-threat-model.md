...
It also records eight Product Owner-approved normative contracts: `SA-92-*`
...
operations (§2.10), and `AN-92-*` analytics and telemetry (§2.11). Those
...
| TB-92-003 | Identity provider ↔ CoBudget | ACT-92-009; SYS-92-001/002/008 | DF-91-001/002/013; DI-91-001–003, 052–053 | Factors/recovery remain IdP-only; session and assurance results are minimal, bound, fresh, revocable, and non-replayable. | EG-91-004, 010 |
...
| DF-91-004 | TB-92-001–002, 004–006, 010–011, 017 | EP-92-005, 015 | TH-92-014, 016, 035–037 |
...
| DF-91-010 | TB-92-001–002, 004–006, 008–009, 013–014, 017 | EP-92-007, 011–012, 015 | TH-92-012, 015, 024–026, 033 |
...
| TH-92-034 | D/E | Authentication, invitation, protected action, webhook, search, export, or lifecycle endpoint lacks bounded rate/resource controls and becomes an enumeration or availability oracle. | DF-91-001–005/009–010/013; TB-92-001–006/010/013/016 | Service availability plus DI-91-001, 005–009, 039, 054, 076 | CBD-72 XSP-02 uniform denial and permission 20a/20b export rate limits; CBD-91 rule 3 | Broad / High / Medium / High | EG-91-004–007, 010–011, 016–017; RF-92-012 owns the absent rate and resource ceilings |
...
| RF-92-012 | No approved input sets a rate, quota, or resource ceiling for any surface outside export packages. CBD-72 requires uniform safe denial through `XSP-02` and imposes rate limits only inside permissions 20a/20b; CBD-91 rule 3 constrains disclosure rather than volume. TH-92-034 therefore names a control CBD-92 cannot inherit from an approved source, and every other threat that depends on bounded retry or bounded attempt volume — TH-92-005, TH-92-023, TH-92-038 and TH-92-044 — rests on the same absent ceiling. | Approved per-surface rate, quota, backoff, lockout and shed thresholds for authentication/recovery, invitation create/resend/accept, protected actions, provider webhook/callback, search/report, export generation/download, and lifecycle request, each with its failure mode and its interaction with availability requirements. Verification must prove the limit does not itself become an enumeration oracle: a threshold that triggers differently for an existing and a non-existent account, recipient, space or package discloses exactly what `XSP-02` and TH-92-005 require to stay uniform. | Architecture + product + CBD-94; EG-91-004–007/010–011/016–017 | Does not block CBD-92 conceptual approval; blocks release of every listed surface, and CBD-94 must establish these ceilings rather than record them as inherited. |
