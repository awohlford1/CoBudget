...
Data Inventory v1.0** (`docs/cbd-91-private-mvp-data-inventory.md`) and the
...
| --- | --- | --- |
| CBD-91 v1.0 / `docs/cbd-91-private-mvp-data-inventory.md` | Data classes, sensitivity, audience, prohibited disclosure, lifecycle, noninterference and copy rules §4, evidence gaps §6, and the §7.3 inactive-owner policy with its clause 8 referral | `DI-91-001`–`DI-91-076` cited throughout §4; §7.3 disposed in §9.2; `EG-91-014` disposed in §7.2 |
